    ...
    <section className={styles.wrapper}>
      <div className={styles.infoBlock}>
        ...
        <span className={styles.subtitle}>
          Привет! Меня зовут Юра. Я Front-end React Developer из
        ...
        <React.Fragment>
          <div className={styles.links}>
            <svg
              ...
              onClick={() =>
                window.location.replace(
                  "https://www.linkedin.com/in/iurii-naumov-b8b9a5239/"
                )
              }
            >
            ...
            <svg
              ...
              height="30px"
              onClick={() =>
                window.location.replace("https://github.com/IuriiNaumov")
              }
            >
